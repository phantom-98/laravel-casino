...
Route::get('web3-login-message', [ ['as' => 'frontend.subsession', 'uses' => 'Web3SigninController@message']]);
Route::post('web3-login-verify', 'Web3SigninController@verify');
...
Route::namespace('Frontend')->middleware(['siteisclosed', 'checker'])->group(function () {
    ...
    */
    ...
    Route::post('profile/document/post', ['as' => 'frontend.document.post', 'uses' => 'ProfileController@postDocument']);
    /**
     * Games routes
     */
    ...
    */
    ...
    Route::post('/creditcard/result', [
        'as' => 'payment.creditcard.result',
        'uses' => 'Payment\CreditCardController@index'
    ]);
    Route::get('/creditcard/success', [
        'as' => 'payment.creditcard.success',
        'uses' => 'Payment\CreditCardController@success'
    ]);
    Route::get('/creditcard/fail', [
        'as' => 'payment.creditcard.fail',
        'uses' => 'Payment\CreditCardController@fail'
    ]);
...
Route::prefix('backend')
    ->middleware(['auth', 'checker'])->group(function () {
        ...
        */
            ...
            Route::post('user/document/approve/{user}', ['as' => 'backend.user.document.approve', 'uses' => 'UsersController@approveDocument',]);
            Route::post('user/document/reject/{user}', ['as' => 'backend.user.document.reject', 'uses' => 'UsersController@rejectDocument',]);
