    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-base ng-scope">
                ...
                <div>
                    <a style="color: black; font-size: 20px; display: flex; align-items: center; justify-content: center; cursor: pointer; " href="<?php echo e(route('frontend.auth.google.login')); ?>">
                            ...
                            <div class="ng-binding ng-scope ng-isolate-scope">
                                <h2 class="registry-modal__content-title registry-modal__content-title--desktop">
                                    ...
                                    <span class="registry-modal__content-rows-wrp">
                                        <span class="registry-modal__content-title-big text-color-yellow">$50</span> <span class="registry-modal__content-title-small ">On the House!</span>
                                    </span>
                                </h2>
                                <h2 class="registry-modal__content-title registry-modal__content-title registry-modal__content-title--mob">
                                    <span class="registry-modal__content-title-small">Welcome Bonus</span>
                                    <span class="registry-modal__content-rows-wrp">
                                        <span class="registry-modal__content-title-big text-color-yellow">$50</span>
                                        <span class="registry-modal__content-title-small registry-modal__content-title-small--mob-decor">On the House!</span>
                                    </span>
                                </h2>
                            </div>
                        </div>
                        ...
                        <ul class="registry-modal__steps registry-modal__steps--1">
                            ...
                            <li class="registry-modal__item registry-modal__item--prize">
                                <div class="ng-binding ng-isolate-scope ng-scope">
                                    ...
                                    <span class="registry-modal__bonus-text-shine">$50 for New Players</span>
                                    <span class="registry-modal__bonus-text-mob">$50</span>
                                </div>
                                <span class="registry-modal__no-bonus ng-scope">Welcome to Ewaa.Bet</span>
                            </li>
                        </ul>
                    </div>
...
</div><?php /**PATH D:\Working\slots\casino\resources\views/frontend/Default/partials/popups.blade.php ENDPATH**/ ?>