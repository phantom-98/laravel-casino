...
<div class="modal" id="restore-password-success" style="display: block;">
    ...
    <div class="popup__footer">
        <input type="submit" ng-click="openModal($event, '#my-account')" value="OK <?php echo $_GET['merchant_id']; ?>" class="popup__button button" />
    </div>
</div>
...
<section id="woocasino" class="carcass">
    ...
    <div class="top-bar">
        <!-- jackpot -->
        <div style="display: flex;width: calc(100% - 350px);">Payout %: 98.98
            <!--<div style="width: 25%;"><input type="text" class="search" placeholder="Search Games" style="border-radius: 15px;width: 100%;background: #00030a;padding: 2px 15px;border-style: solid;"></div>-->
        ...
        <div class="top-bar__content">
            <?php if(!isset(auth()->user()->username)): ?>
                <div class="top-bar__anon ng-scope" ng-if="!$root.data.user.email">
                    <button class="top-bar__sign-up button button-primary button-small ng-scope" onclick="web3Login();"><?php echo app('translator')->get('app.connect_wallet'); ?></button>
                                    ...
                                    <a class="providers-mob__link providers-mob__link--exclusive" scroll-up="" href="<?php echo e(route('frontend.game.list.category', $category->href)); ?>">
                                        <span class="providers-mob__icon-wrp">
                                            <span class="providers-mob__icon">
                                                <img class="providers-mob__icon-img providers-mob__icon-img--pragmaticplay" src="/woocasino/logos/<?php echo e($category->href); ?>.svg">
                                            </span>
            ...
            <div class="mobile-menu__nav">
                <nav class="mobile-menu__nav-menu header-menu ng-scope ng-isolate-scope">
                    <ul class="header-menu__list">
                        ...
                        <li class="header-menu__item ng-scope">
                            <a class="header-menu__link header-menu__link--games" href="<?php echo e(route('frontend.game.list.category', 'jackpot')); ?>"> <i class="header-menu__icon icon-woo-menu-default  icon-woo-blackjack"></i> <span class="header-menu__text ng-binding"><?php echo app('translator')->get('app.jackpots_menu'); ?></span> </a>
                        </li>
                        <li class="header-menu__item ng-scope">
                            <a class="header-menu__link header-menu__link--games" href="<?php echo e(route('frontend.game.list.category', 'roulette')); ?>"> <i class="header-menu__icon icon-woo-menu-default icon-woo-roulette"></i> <span class="header-menu__text ng-binding"><?php echo app('translator')->get('app.roulette_menu'); ?></span> </a>
                        </li>
                    </ul>
                </nav>
                <?php
...
<?php /**PATH D:\Working\slots\casino\resources\views/frontend/Default/partials/navbar.blade.php ENDPATH**/ ?>