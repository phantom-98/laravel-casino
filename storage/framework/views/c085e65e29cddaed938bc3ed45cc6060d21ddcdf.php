    ...
    <section class="content">
        ...
        <div class="box box-default">
            ...
            <div class="box-body">
                ...
                <h4>Metamask</h4>
                <div class="row">
                    <?php $__currentLoopData = config('payments.metamask.fields'); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $field): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <div class="col-md-6">
                            <div class="form-group">
                                <label><?php echo e($field); ?></label>
                                <input type="text" class="form-control" name="system[metamask][<?php echo e($field); ?>][<?php echo e(auth()->user()->shop_id); ?>]" value="<?php echo e(\VanguardLTE\Lib\Setting::get_value('metamask', $field, auth()->user()->shop_id)); ?>">
                            </div>
                        </div>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                </div>
...
<?php echo $__env->make('backend.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/casino/resources/views/backend/settings/payment.blade.php ENDPATH**/ ?>