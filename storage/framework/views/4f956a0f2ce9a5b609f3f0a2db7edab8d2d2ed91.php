...
<body style="...">
    <script>
        ...
        <script src="/games/<?php echo e($game->name); ?>/jsout.js"></script>
        <script>
            console.log('<?php echo e($device); ?>');
            var params = {
...
/*          "playerid": playerId,
"password": password,*/
            "basedir": "<?php echo e(config('app.url')); ?>games/<?php echo e($game->name); ?>/",
            "hostname": "<?php echo e(config('app.hostname')); ?>:6969",
            "port": "6969",
            "skin": "english",
            "roomid": "InitGame:<?php echo e($game->name); ?>:"+sessid()+":"+document.cookie,
            "gamename": "<?php echo e($game->name); ?>",
           "devicetype": "<?php echo e($device); ?>",
           "screenrotation.enabled": "0",
            ...
            "branding": "stargames",
            //"debug": "true",
            //"resourceurl": "/games/<?php echo e($game->name); ?>/",
            "closeurl": "/",
    ...
    let socket = new WebSocket("wss://<?php echo e(config('app.hostname')); ?>:7878/shop=<?php echo e(auth()->user()->shop_id); ?>");
...
<?php /**PATH /var/www/casino/resources/views/frontend/games/list/AgeofprivateersGT.blade.php ENDPATH**/ ?>