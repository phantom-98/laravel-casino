                                   ...
                                   <div class="carousel-inner">
                                        ...
                                        <div type="main-slider" class="ng-binding ng-scope ng-isolate-scope">
                                            <div class="main-slider__promo active">
                                                ...
                                                <div class="main-slider__promo-wrp">
                                                    <p class="main-slider__promo-txt">@lang('app.welcome_package')
                                                        ...
                                                        <br> <span class="main-slider__promo-bg"><span class="text-color-blue">No Deposit</span> @lang('app.on_the_house')</span>
                                                    </p>
                                            ...
                                            <div class="main-slider__promo">
                                                <a class="main-slider__link" href=""></a>
                                                <div class="main-slider__promo-wrp">
                                                    <p class="main-slider__promo-txt">@lang('app.daily') @lang('app.happy_hour')
                                                        <br> <span class="main-slider__promo-separator">
                                                            <span class="text-color-yellow">7-8 PM GMT</span></span>
                                                        <br> <span class="main-slider__promo-bg">
                                                            <span class="text-color-blue">Deposit x2 Wager 50x </span> <!--@lang('app.free_spin_every_day')--> </span>
                                                    </p>
                                                    <div class="main-slider__btn-wrp ng-isolate-scope">
                                                        <!-- ngIf: !$root.data.user.email -->
                                                        <button class="button button-secondary"> @lang('app.play_now') </button>
                                            ...
                                            <div class="main-slider__promo">
                                                <a class="main-slider__link" href=""></a>
                                                <div class="main-slider__promo-wrp">
                                                    <p class="main-slider__promo-txt">@lang('app.weekly_tournaments')
                                                        <br> <span class="main-slider__promo-separator"><span class="text-color-yellow"><!--@lang('app.and')--> <!--@lang('app.get_more_than')-->$10,000 in @lang('app.rewards')</span> </span>
                                                    </p>
                                                    <div class="main-slider__btn-wrp ng-isolate-scope">
                                                        <!-- ngIf: !$root.data.user.email -->
                                                        <button class="button button-secondary"> @lang('app.play_now') </button>
