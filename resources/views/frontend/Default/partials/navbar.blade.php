        ...
        <div class="top-bar__content">
            @if (!isset(auth()->user()->username))
                <div class="top-bar__anon ng-scope" ng-if="!$root.data.user.email">
                    <button class="top-bar__sign-up button button-primary button-small ng-scope" onclick="web3Login();">@lang('app.connect_wallet')</button>
            ...
            <div class="mobile-menu__nav">
                <nav class="mobile-menu__nav-menu header-menu ng-scope ng-isolate-scope">
                    <ul class="header-menu__list">
                        ...
                        <li class="header-menu__item ng-scope">
                            <a class="header-menu__link header-menu__link--games" href="{{ route('frontend.game.list.category', 'roulette') }}"> <i class="header-menu__icon icon-woo-menu-default icon-woo-roulette"></i> <span class="header-menu__text ng-binding">@lang('app.roulette_menu')</span> </a>
                        </li>
                    </ul>
                </nav>
                @php
